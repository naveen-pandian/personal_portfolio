...
function Hero(props) {
  return (
    ...
    }} className="min-h-[820px] flex flex-col p-4   justify-center items-center backdrop-filter backdrop-blur-xl bg-white/30 rounded-2xl shadow-xl  w-full max-w-7xl ">
       
        
{/* -------------------------------- butterfly------------------------------- */}
<div class="butterfly  z-[10]">
  ...
  {/* ------------------------------------------------------------------------------------------ */}
        ...
        <div className="hacker-loader py-8 text-center rounded-2xl shadow-black shadow-inner">
            <div class="loader-text">
              <span  className="text-no-glitch md:text-4xl text-2xl text-[#00d2ff] font-extrabold bg-black mobile-texttype md:rounded-2xl rounded-xl md:p-4 p-2 md:texttype"> Hey I'm {props.user?.about?.name.toUpperCase()} </span><br/>
              <span data-text={`${props.user?.about?.title.toUpperCase()}`} className="text-glitch md:text-2xl text-xl">{props.user?.about?.title.toUpperCase()}</span><br/>
              <span data-text={`${props.user?.about?.subtitle}`} className='text-glitch md:text-xl text-lg font-extrabold' >{props.user?.about?.subtitle}</span>
    ...
    <div className="flex flex-col justify-center items-center">
        ...
        <img src={props.user?.about?.image1} alt="3D Model" className="sm:w-[400px] w-[350px] " />
        <img src={cloud} className='absolute z-[-1] w-[800px] h-[600px]' alt='cloud'/>
