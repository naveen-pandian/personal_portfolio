...
function Loading(props) {
  return (
    <div
    className=" h-screen bg-[rgba(128,0,128,1)] overflow-hidden drop-shadow-xl"
  >
    ...
    <div className="py-8 px-2 md:px-8 font-extrabold text-lg md:text-xl text-white">
      <div>
        <span className=' text-[#0f0]'>naveen-pandian</span>
        : <span className="text-blue-500">~</span>
        $ <span className=""> sudo apt-get personal-portfolio</span><br/>
